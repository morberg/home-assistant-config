$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-label"] = new basedisplay("default-label", "", "obsidian", {'widget_type': 'basedisplay', 'fields': {'title': '', 'title2': '', 'value': 'Hello World', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'unit_style': '', 'value_style': 'color: #00FFFF;', 'state_text_style': 'color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'css': {}, 'icons': [], 'static_icons': []})
